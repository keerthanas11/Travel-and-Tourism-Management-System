...
public class Addcus extends JFrame implements ActionListener {
    private JTextField  t2, t4, t5, t6, t7,t1,t3;
    ...
    Addcus(String username) {
        ...
        c1 = new JComboBox<String>(new String[] { "Passport", "Aadhar Card", "Ration Card", "Pan Card" });
        ...
        male = new ImageIcon(ClassLoader.getSystemResource("icons/dest9.jpg"));
        Image m2 = male.getImage().getScaledInstance(30, 30, Image.SCALE_DEFAULT);
        ImageIcon m3 = new ImageIcon(m2);
        r1.setIcon(m3);
        female = new ImageIcon(ClassLoader.getSystemResource("icons/dest8.jpg"));
        ...
        try {
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from new1 where username = '" + username + "' ");
            while (rs.next()) {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            Conn c = new Conn();
           // c=DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism","root","deekshitha2602");
           //s=c.createStatement();
